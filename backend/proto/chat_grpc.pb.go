...
type ChatServiceClient interface {
	...
	ReceiveMessages(ctx context.Context, in *Message, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Message], error)
}
...
func (c *chatServiceClient) ReceiveMessages(ctx context.Context, in *Message, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Message], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ChatServiceServer interface {
	...
	ReceiveMessages(*Message, grpc.ServerStreamingServer[Message]) error
...
func (UnimplementedChatServiceServer) ReceiveMessages(*Message, grpc.ServerStreamingServer[Message]) error {
...
func _ChatService_ReceiveMessages_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ChatServiceServer).ReceiveMessages(m, &grpc.GenericServerStream[Message, Message]{ServerStream: stream})
}
